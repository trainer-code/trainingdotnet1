...
namespace Battleship.Ascii
{
    ...
    public class Program
    {
        ...
        public static void ShowInstruction(string message)
        {
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine(message);
        }

        public static void ShowPosition(string message)
        {
        ...
        private static void InitializeMyFleet()
        {
            ...
            {
                Console.WriteLine();
                ShowPosition(String.Format("Please enter the positions for the {0} (size: {1})", ship.Name, ship.Size));
                for (var i = 1; i <= ship.Size; i++)
                {
                    ShowPosition(String.Format("Enter position {0} of {1} (i.e A3):", i, ship.Size));
